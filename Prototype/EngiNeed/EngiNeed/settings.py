"""
Django settings for EngiNeed project.
...
WSGI_APPLICATION = 'EngiNeed.wsgi.application'
...
STATIC_URL = 'EngiNeed/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static')
]
STATIC_ROOT = os.path.join(BASE_DIR, 'EngiNeed/static')
